...
$jscomp.makeIterator=function(a){$jscomp.initSymbolIterator();var b=a[Symbol.iterator];if(b)return b.call(a);var c=0;return{next:function(){return c<a.length?{done:!1,value:a[c++]}:{done:!0}}}};var Data=function(){this.type=this.width=this.height=this.subCaption=this.caption="";this.chartData=[]};
Data.prototype.ajaxLoader=function(a,b){var c=new XMLHttpRequest;if(!c)return console.log("Unable to create XMLHTTP instance."),!1;c.open("POST",a,!0);c.onreadystatechange=function(){c.readyState===XMLHttpRequest.DONE&&(200===c.status?b(JSON.parse(c.responseText)):console.log("There was a problem with the request"))};c.send()};
...
SvgHelper.prototype.drawCircleByClass=function(a,b,c,d){var e=document.createElementNS(this.svgns,"circle");e.setAttributeNS(null,"cx",a);e.setAttributeNS(null,"cy",b);e.setAttributeNS(null,"r",c+"px");e.setAttributeNS(null,"class",d);return e};SvgHelper.prototype.getRotationPoint=function(a){a=a.getBBox();return a.x+14+", "+(a.y+a.height/2)};
var MultiVarChart=function(a,b,c,d,e,f,g,k){this.index=a;this.type=b;this.xTitle=c;this.yTitle=d;this.xData=e;this.yData=f;this.xUnit=g;this.yUnit=k},MappedChart=function(a,b,c,d,e,f,g){this.index=a;this.xTitle=b;this.yTitle=c;this.xData=d;this.yData=e;this.yTicks=f;this.xTicks=g},chartUtilities={nullMinMapper:function(a){return""===a?Infinity:a},nullMaxMapper:function(a){return""===a?-Infinity:a},isSvgColliding:function(a,b){return!(b.left>a.right||b.right<a.left||b.top>a.bottom||b.bottom<a.top)},
getLineIntersectionPoint:function(a,b,c,d,e,f,g,k){var l,h={x:null,y:null};l=(a-c)*(f-k)-(b-d)*(e-g);if(!l)return h;h.x=((a*d-b*c)*(e-g)-(a-c)*(e*k-f*g))/l;h.y=((a*d-b*c)*(f-k)-(b-d)*(e*k-f*g))/l;return h},getInterpolatedVal:function(a,b,c,d,e){a=Number(a);c=Number(c);b=Number(b);d=Number(d);return Math.round(100*(b+(e-a)/(c-a)*(d-b)))/100}},ColumnChartRenderer=function(a,b){this.charts=a;this.chartProperties=b};
...
"rotate(270 "+q+")")}}};var LineChartRenderer=function(a,b){this.charts=a;this.chartProperties=b};
...
LineChartRenderer.prototype.drawCompleteCharts=function(a,b,c,d,e,f,g,k){var l=Math.ceil(g-.001*g)+55,h=Math.ceil(k-.025*k)+55;k=Math.floor(0+.2*g)+55;g=Math.floor(0+.025*g)+55;var q=l-k,r=h-g,n=this.chartProperties.dataMapper(q,r,k,g,b[a]);[].push(n);var m=e.drawLineByClass(g,k-55,g,l-55,"yAxis");f.appendChild(m);m=e.drawLineByClass(h,l-55,g,l-55,"xAxis");f.appendChild(m);h=e.drawTextByClass(h/2-15,k-55-20,""===b[a].yUnit?b[a].yTitle:b[a].yTitle+" ("+b[a].yUnit+")","y-title");m=e.drawRectByClass(g,
k-55-40,30,r,"y-title-rect");f.appendChild(m);f.appendChild(h);h=$jscomp.makeIterator(n.xTicks);for(m=h.next();!m.done;m=h.next()){var m=m.value,p=e.drawLineByClass(m,l-55,m,l+5-55,"xTick");f.appendChild(p);a>=c.length-d&&(p=b[a].xData[n.xTicks.indexOf(m)],m=e.drawTextByClass(m-13,l-23,p,"x-value"),f.appendChild(m))}c=$jscomp.makeIterator(n.yTicks);for(d=c.next();!d.done;d=c.next())d=d.value,h=e.drawLineByClass(g-5,d-55,g,d-55,"yTick"),f.appendChild(h),h=e.drawRectByClass(g,d-55,q-d+n.yTicks[0],r,
"yDiv"),f.appendChild(h),h=b[a].yTicks[n.yTicks.indexOf(d)],d=e.drawTextByClass(50,l-d+k-50,h,"y-value"),d.setAttributeNS(null,"text-anchor","end"),f.appendChild(d);for(l=0;l<n.yData.length-1;l++)if(c=0,""!==n.yData[l+1]&&""!==n.yData[l])c=e.drawLineByClass(n.xData[l]+g,q-n.yData[l]+k-55,n.xData[l+1]+g,q-n.yData[l+1]+k-55,"graphLine"),f.appendChild(c);else if(""!==n.yData[l])for(d=l+2;d<n.yData.length;d++)if(l++,c++,""!==n.yData[d]){c=e.drawLineByClass(n.xData[l-c]+g,q-n.yData[l-c]+k-55,n.xData[d]+
g,q-n.yData[d]+k-55,"graphLine inferredLine");f.appendChild(c);break}for(l=0;l<n.yData.length;l++)""!==n.yData[l]&&(c=e.drawCircleByClass(n.xData[l]+g,q-n.yData[l]+k-55,4,"graphCircle"),c.setAttributeNS(null,"data-value",b[a].yData[l]),f.appendChild(c));a=e.drawRectByClass(g,k-55,q,r,"chart-rect");a.setAttributeNS(null,"fill-opacity",0);f.appendChild(a)};
...
"rotate(270 "+q+")")}}};var ChartPropertyCalculator=function(a){this.charts=a};
...
this.removeCrosshair),d.addEventListener("crosshairRemoveEvent",this.removeOtherCrosshairs.bind(this));b.addEventListener("mousedown",this.dragSelect);b.addEventListener("customDragSelect",this.customDragSelect.bind(this));b.addEventListener("customExpandSelect",this.customExpandSelect.bind(this));b.addEventListener("customSelectPlots",this.customSelectPlots.bind(this))}};var Chart=function(a){this.render=function(){var b=new Data;b.ajaxLoader(a,b.dataParser.bind(b));b.customSort=this.customSort}};var chart=new Chart("res/data/user_data.json");chart.customSort=function(){for(var a=[],b=$jscomp.makeIterator(this.chartData),c=b.next();!c.done;c=b.next()){for(var d=0,e=0,c=$jscomp.makeIterator(c.value.yData),f=c.next();!f.done;f=c.next())f=f.value,""!==f&&(d+=f,e++);a.push(d/e)}this.chartData=this.multiSort(a,this.chartData,"descending")};chart.render();
}).call(this)
